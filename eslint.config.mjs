...
export default withVueTs(
  {
    ...
    ignores: [
      ...
      'new_designs/**',
      'copilot/**',
      // Feature working notes (git-ignored), incl. vendored design-previewer
      // tooling. Renamed from copilot/ in the 2026-07-13 feature-builder
      // migration; .claude/CLAUDE.md itself stays linted (only /features/).
      '.claude/features/**',
      'docs/**',
